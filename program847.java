...
class MarvellousDBMS implements Serializable{
    ...
    // Select * from Employee where EmpName = user_name
    ...
    public void DeleteSpecificID(int id){
        ...
        if(found == false){
            ...
            Table.remove(index);
            // Counter--; // This will not work here
...
class program847{
    public static void main(String Args[]) throws Exception{
        ...
        while(iOption != 20){
            ...
            System.out.println("6: Select * from Employee where EmpID = ");
            System.out.println("7: Update * from Employee where EmpID = ");
            System.out.println("8: Take a backup of Table");
